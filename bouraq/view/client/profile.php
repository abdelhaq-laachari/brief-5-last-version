    ...
    <div class="l-navbar" id="navbar">
        <nav class="nav">
            <div>
                ...
                <div class="nav__list">
                    <a href="http://localhost/youcode/4test/view/client/profile.php" class="nav__link active">
                        <i class="fa-solid fa-user" style="font-size: 1.5rem;"></i>
                        <span class="nav__name">Profile</span>
                    </a>
                    <a href="http://localhost/youcode/4test/view/client/new_booking.php" class="nav__link">
