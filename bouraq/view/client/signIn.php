              ...
              <form action="http://localhost/youcode/4test/signinClient/profile" method="POST">
                ...
                <div class="text-center text-lg-start mt-4 pt-2">
                    ...
                    <p class="small fw-bold mt-2 pt-1 mb-0">Don't have an account? 
                      <a href="http://localhost/youcode/4test/signup"class="link-danger">Sign up</a>
                    </p>
                    <p class="small fw-bold mt-2 pt-1 mb-0">Log in as admin? 
                      <a href="http://localhost/youcode/4test/signinAdmin"class="link-danger">Admin</a>
                    </p>
                </div>
