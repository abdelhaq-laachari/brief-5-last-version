            ...
            <table class="table table-hover table-borderless" >
                <thead class="table-dark">
                    <tr>
                        ...
                        <!-- <th scope="col">Day of departure</th> -->
                        <th scope="col">Hour of departure</th>
                ...
                <form action="http://localhost/youcode/4test/trip/AddTrip" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="Arrivale_City" id="Arrivale_City" class="form-control"  required >
                        </div>

                        <div class="form-group">
                            <label> Date of Departure </label>
                            <input type="text" name="Date_of_Departure" id="Date_of_Departure" class="form-control" required  >
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="dayD" id="PasteDate" class="form-control"  required >
                        </div>
                        <div class="form-group">
                            <label> Price </label>
                        ...
                        <!-- <div class="form-group">
                            ...
                            <input type="datetime-local" name="today" id="Paste_Date" class="form-control"  >
                        </div> -->
                        <div class="form-group">
                            <label> Train </label>
                            
                            <select name="idTrain" class="form-select" aria-label="Default select example" required>
                                <option selected disabled>Select Train</option>
                                <option value="1">AL BOURAQ</option>
                                <option value="2">AL ATLAS</option>
                                <option value="3">ONCF</option>
                            </select>
                        </div>
                    </div>
