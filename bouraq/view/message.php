...
<body>
    ...
    <!-- Modal -->
    <div class="modal fade modal-dialog modal-dialog-scrollable" id="studentaddmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <form action="insertcode.php" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="insertdata" class="btn btn-primary">Confirm</button>
                    </div>
                </form>
    ...
    <div class="container">
        <div class="jumbotron">
            ...
            <div class="card">
                ...
                $db = mysqli_select_db($connection, 'poo');
